...
import com.pageFunctions.addpeoplefunc;
		...
		public class ParentVtKidVtInsurance extends BaseClass {
		...
		lgnpage= new UAT_CreateAccountFunc(d);
			...
			public void testcase1(String pswd,String Lname,String dob,String sex, String addrl1,  String ct,  String st,String zip1,String elig,String enrlmnt,String plan,String date,String benefits,String newmem,String db1, String gndr1,String enrlt1,String rltn,String incmtyp,String empname,String strt,String citi,String ste,String zpcd,String amt,String freq,String stdate) throws Exception {
	 ...
	 @DataProvider (name="testcase")
	  ...
	  public Object[][] reg() throws Exception
	  {
		   ...
		   Object[][] testObjArray = ExcelUtilities.getTableArray2(".\\TestData\\FPL.xlsx","Sheet7", 2,27);
		   return (testObjArray);
